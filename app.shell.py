...
def main():
    with st.sidebar:
        ...
        retreival_limit = st.slider('How many results do you want to see?', min_value=10, max_value=300, value=50, step=10)
        reranker_topk = st.slider('How many results should I rerank (the more I need to rerank, the longer it takes)', min_value=1, max_value=5, value=3, step=1)
        temperature_input = st.slider('Choose a temperature between 0 and 5: the higher it is, the more random my output will be', min_value=0.0, max_value=2.0, value=0.1, step=0.1)
